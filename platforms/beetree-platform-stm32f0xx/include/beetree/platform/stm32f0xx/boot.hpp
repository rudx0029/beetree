...
namespace tim3 {
///
/// Boots timer 3 for use as a PWM on pins PB0 and PB1.
///     - GPIO Pin PB0 is TIM3's channel 3
///     - GPIO Pin PB1 is TIM3's channel 4
///
/// @param autoreload (default is 512) auto reload count which specifies the
/// frequency of the PWM
/// @param prescaler not sure?
///
void boot_pwm_pb0_pb1(uint32_t autoreload = 512, uint32_t prescaler = 2);
}  // namespace tim3

namespace tim15 {
void boot_counter_pb14(uint32_t autoreload = 32768, uint32_t prescaler = 0);
}  // namespace tim15
