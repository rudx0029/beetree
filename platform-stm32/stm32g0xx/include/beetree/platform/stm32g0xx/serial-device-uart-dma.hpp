...
#include "beetree/platform/stm32g0xx/serial-params.hpp"
#include "beetree/platform/stm32g0xx/usart-dev-id.hpp"

namespace stm32g0xx {
///
/// stm32g0xx Asynchronous Serial Interface for USART devices with DMA
/// support.
///
