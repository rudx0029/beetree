                        ...
                        const SerialParams& serial_params)
{
    ...
    LL_DMA_SetPeriphRequest(dma, dma_rx_channel, LL_DMAMUX_REQ_USART2_RX);
    ...
    /* USART_TX Init */
    LL_DMA_SetPeriphRequest(dma, dma_tx_channel, LL_DMAMUX_REQ_USART2_TX);
    ...
    // need this for G0
    devcfg.PrescalerValue = LL_USART_PRESCALER_DIV1;
    ...
    LL_USART_DisableOverrunDetect(usart);
